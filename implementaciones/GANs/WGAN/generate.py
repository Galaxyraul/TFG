...
# === Config ===
model_path = '/raid/rgt00024/tfg/from_scratch/gans/wgan/checkpoints/drones/100/gen.pt'        # Your pretrained model (.pth)
...
# === Load model ===
from wgan import Generator    # Replace with your actual model class
