...
# === Config ===
model_path = '/raid/rgt00024/tfg/from_scratch/gans/dcgan/checkpoints/celeba/20/gen.pt'        # Your pretrained model (.pth)
...
# === Load model ===
from dcgan import Generator    # Replace with your actual model class
