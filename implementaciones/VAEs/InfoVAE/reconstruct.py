...
model_path = '/raid/rgt00024/tfg/from_scratch/vaes/infovae/checkpoints/celeba/infovae_epoch_020.pt'       # Your model checkpoint
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

# === Load model ===
from infovae import InfoVAE   # Replace with actual model
model = InfoVAE().to(device)
