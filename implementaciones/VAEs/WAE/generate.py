...
# === Config ===
model_path = '/raid/rgt00024/tfg/from_scratch/vaes/wae_mmd/checkpoints/drones/wae_epoch_100.pt'      # Your pretrained model (.pth)
...
# === Load model ===
from wae import WAE    # Replace with your actual model class
model = WAE(img_channels=3,latent_dim=128).to(device)
